package com.codeone.controller.naver;
...
public class NaverCloud {
	...
	public static String stt(String filepath) {
		...
		String clientId = "o2jlgkap0z";             // Application Client ID";
        String clientSecret = "anAVrFaEWV7vRZ9B893ZNjCBavlniiNrj7OAmUhO";     // Application Client Secret";
	...
	public static boolean tts(String voiceStr, String filepath) {
		String clientId = "o2jlgkap0z";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "anAVrFaEWV7vRZ9B893ZNjCBavlniiNrj7OAmUhO";//애플리케이션 클라이언트 시크릿값";
	...
	public static String ocr(String filepath) {
		String apiURL = "https://7krazpabhq.apigw.ntruss.com/custom/v1/21542/c28ec953c2c4e628912ccfe719b0055de5b51de56f6783609749529c355c2678/infer";
		String secretKey = "bWtzZWVqSnNlT2x0ZFNTU1RDcW5ISkF0VktaaFJzQXo=";
	...
	public static String chatBot(String voiceMessage) {
		...
		String apiURL = "https://nvohpcxn78.apigw.ntruss.com/custom/v1/10537/8310b76062f841a003e706e6bc513b540a254e5ad07aea95f4acf3df2ac892d0";
		String secretKey = "bVp1RnBwZ2RDSFlia2lQUGZ2SWp0SXR3SnZnR0pIY1g=";

		
	    String chatbotMessage = "안녕";
