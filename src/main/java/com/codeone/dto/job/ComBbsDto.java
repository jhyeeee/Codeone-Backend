...
//	}
//
//	public ComBbsDto(String id, String title, String content) {
//		super();
//		this.id = id;
//		this.title = title;
...
//	}
//
//	public ComBbsDto(int seq, String id, int ref, int step, int depth, String title, String content, String wdate, int del,
//			int readcount) {
//		super();
//		this.seq = seq;
//		this.id = id;
