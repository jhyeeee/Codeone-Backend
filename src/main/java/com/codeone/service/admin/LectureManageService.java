...
import com.codeone.dao.admin.LectureManageDao;
...
public class LectureManageService {
	...
	public List<LectureDto> getMngLectureList() {
		return dao.getMngLectureList();
	}
	...
	// 관리자 강의목록 숨김/노출
	public boolean showHideLecture (int seq, int delflg) {
		return dao.showHideLecture(seq,delflg);
	}
